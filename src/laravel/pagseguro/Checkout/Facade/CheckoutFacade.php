...
class CheckoutFacade
{
     ...
     */
    public function createFromArray(array $data, $ref = null)
    {
        ...
        return $this->createSimpleCheckout($data, $ref);
    }
     ...
     * @return GamerCheckout
     */
    public function createSimpleCheckout(array$data, $ref = null)
    {
        $dataFacade = new DataFacade();
        $checkoutData = $dataFacade->ensureInstances($data);
        $checkout = new SimpleCheckout($checkoutData);
        $checkout->setReference($ref);
        return $checkout;
    }
